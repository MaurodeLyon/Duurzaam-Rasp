...
def checkAPI():
    ...
    if sunriseDataSplit[1] == "PM":
        f = "2016-04-05 " + str(sunriseTime.tm_hour + 12) +":"+ str(sunriseTime.tm_min)+":" + str(sunriseTime.tm_sec) # create string
    else:
        f = "2016-04-05 " + str(sunriseTime.tm_hour) +":"+ str(sunriseTime.tm_min)+":" + str(sunriseTime.tm_sec) # create string
    ...
    if sunsetDataSplit[1] == "PM":
        f = "2016-04-07 " + str(sunsetTime.tm_hour + 12) +":"+ str(sunsetTime.tm_min)+":" + str(sunsetTime.tm_sec) # create string
    else:
        f = "2016-04-07 " + str(sunsetTime.tm_hour) +":"+ str(sunsetTime.tm_min)+":" + str(sunsetTime.tm_sec) # create string
    ...
    if(sunriseTime < currentTime and sunsetTime > currentTime):
        ...
        isZonOnder = 1
    print "sunriseTime : %s" % sunriseTime
    print "sunsetTime : %s" % sunsetTime
...
while True:
    ...
    checkLICHT()
    checkAPI()
    if isLicht and not isZonOnder and isBeweging:
